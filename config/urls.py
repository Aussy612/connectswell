...
urlpatterns = [
                  ...
                  path("my-profile/", TemplateView.as_view(template_name="pages/my-profile.html"),
                       name="my-profile"),
                  path("get-points/", TemplateView.as_view(template_name="pages/get-points.html"),
                       name="get-points"),
                  path("how-to-play/", TemplateView.as_view(template_name="pages/how-to-play.html"),
                       name="how-to-play"),
                  path("login/", TemplateView.as_view(template_name="pages/login.html"),
                       name="login"),
                  path("make-a-team/", TemplateView.as_view(template_name="pages/make-a-team.html"),
                       name="make-a-team"),
                  path("my-profile/", TemplateView.as_view(template_name="pages/my-profile.html"),
                       name="my-profile"),
                  path("rewards/", TemplateView.as_view(template_name="pages/rewards.html"),
                       name="rewards"),
                  path("schedule/", TemplateView.as_view(template_name="pages/schedule.html"),
                       name="schedule"),
